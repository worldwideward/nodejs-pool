...
function Coin(data){
    ...
    // Should be configured in configfile
	...
	console.debug("[DEBUG] getPortLastBlockHeader for port: " + port)
        global.support.rpcPortDaemon(port, 'getlastblockheader', [], function (body) {

	    console.debug("[DEBUG] getPortLastBlockHeader RPC Body: " + body.result)
	...
	console.debug("[DEBUG] Pool Wallet address: " + global.config.pool_wallet_address)
	    ...
	    console.debug("[DEBUG] getPortBlockTemplate RPC Body: " + body.result)
