...
module.exports = function () {
    return {
	    ...
	    console.log("[DEBUG] rpcDaemon method: " + method + " params: " + params + " port: " + port)
	    ...
	    console.log("[DEBUG] rpcPortDaemon method: " + method + " params: " + params + " port: " + port)
            rpc(global.config.daemon.address, port, method, params, callback, 30*1000);
        },
        rpcPortDaemon2: function (port, method, params, callback) {
	    console.log("[DEBUG] rpcPortDaemon2 method: " + method + " params: " + params + " port: " + port)
